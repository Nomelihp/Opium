...
// Ajoute une image dans la zone de sélection des images de l'étalonnage à partir d'un nom de fichier
var ajouteImageEtalonnage = function (nomFichier)
{
	$("#drag-zone-etalonnage").append("<div draggable=\"true\" ondragstart=\"drag(event)\" class=\"miniatures-a-draguer\">"+nomFichier+"</div>");
}
		...
		xhr.upload.onprogress = function(e) {
			if (e.lengthComputable) {
				...
				if (percentComplete == 100)
				{
					...
					ajouteImageEtalonnage(fichier.name);
				}
			}
		};
