...
var nouveau_chantier = require('./routes/nouveau_chantier');
var nouveau_chantier_upload_img = require('./routes/nouveau_chantier_upload_img');
var exemples = require('./routes/exemples');
...
app.use('/nouveau_chantier',nouveau_chantier);
app.use('/nouveau_chantier_upload_img',nouveau_chantier_upload_img);
app.use('/exemples',exemples);
